...
async def create_model(
    ...
    model = RagModel(
        ...
        neighbor_radius=body.neighbor_radius if body.neighbor_radius is not None else 1,
        ...
        rerank_candidates=body.rerank_candidates if body.rerank_candidates is not None else settings.default_rerank_candidates,
        rerank_threshold=body.rerank_threshold if body.rerank_threshold is not None else settings.default_rerank_threshold,
